...
public class VoteResult implements org.apache.thrift.TBase<VoteResult, VoteResult._Fields>, java.io.Serializable, Cloneable, Comparable<VoteResult> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("VoteResult");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new VoteResultStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new VoteResultTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(VoteResult.class, metaDataMap);
  }
  ...
  public VoteResult setTerm(int term) {
    this.term = term;
    setTermIsSet(true);
    return this;
  }
  ...
  public VoteResult setVoteGranted(boolean voteGranted) {
    this.voteGranted = voteGranted;
    setVoteGrantedIsSet(true);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof VoteResult)
      return this.equals((VoteResult)that);
    return false;
  }

  public boolean equals(VoteResult that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("VoteResult(");
    boolean first = true;
  ...
  private static class VoteResultStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public VoteResultStandardScheme getScheme() {
      return new VoteResultStandardScheme();
    }
  }

  private static class VoteResultStandardScheme extends org.apache.thrift.scheme.StandardScheme<VoteResult> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, VoteResult struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, VoteResult struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class VoteResultTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public VoteResultTupleScheme getScheme() {
      return new VoteResultTupleScheme();
    }
  }

  private static class VoteResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<VoteResult> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, VoteResult struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, VoteResult struct) throws org.apache.thrift.TException {
